...
const cards = [
  {
    ...
    ctaText: "Visit",
    ctaLink: "http://bimatek.rf.gd/",
    content: () => {
      return (
        <p>
          MagicAi adalah sebuah Ai yang dapat generate text to text maupun image to text. Project ini adalah hasil gabut yang saya bikin. MagicAi menggunakan Ai dari Gemini, ini menggunakan Api Gratis, jadi maklumin bila banyak error 😊
        </p>
      );
    },
  },
  {
    ...
    ctaText: "Visit",
    ctaLink: "https://uandicode.streamlit.app/",
    content: () => {
      return (
        <p>
