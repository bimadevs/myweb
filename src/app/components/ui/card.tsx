...
export function CardAnimate() {
    return (
        <Card>
            ...
            <CardTitle>Teknologi yang saya pahami</CardTitle>
            <CardDescription>
                HTML, CSS, Javascript, Tailwind, dan React
            </CardDescription>
        </Card>
    );
}
        ...
        <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
            <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
                <Container className="h-8 w-8 circle-1">
                    <Html className="h-4 w-4 " />
                </Container>
                <Container className="h-12 w-12 circle-2">
                    <Css className="h-6 w-6 dark:text-white" />
                </Container>
                <Container className="circle-3">
                    <Javascript className="h-8 w-8 dark:text-white" />
                </Container>
                <Container className="h-12 w-12 circle-4">
                    <Tailwind className="h-6 w-6 " />
                </Container>
...
export const Card = ({
    ...
    return (
        <div
            className={cn(
                "my-8 max-w-sm w-full mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] bg-[rgba(40,40,40,0.70)]  group",
                className
            )}
        >
            {children}
...
export const Html = ({ className }: { className?: string }) => {
    return (
        <svg className="w-6 h-6 text-orange-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
...
export const Javascript = ({ className }: { className?: string }) => {
    return (
        <svg className="w-6 h-6 text-yellow-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            <path d="m3 2 1.578 17.824L12 22l7.467-2.175L21 2H3Zm14.049 6.048H9.075l.172 2.016h7.697l-.626 6.565-4.246 1.381-4.281-1.455-.288-2.932h2.024l.16 1.411 2.4.815 2.346-.763.297-3.005H7.416l-.562-6.05h10.412l-.217 2.017Z" />
        </svg>
    );
};
...
export const ReactLogo = ({ className }: { className?: string }) => {
    return (
        <svg className="w-6 h-6 text-sky-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
